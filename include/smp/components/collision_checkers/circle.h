...
*/
#ifndef _SMP_COLLISION_CHECKER_CIRCLE_H_
#define _SMP_COLLISION_CHECKER_CIRCLE_H_
...
namespace smp {
    ...
    */
    ...
    class collision_checker_circle : public collision_checker_base<typeparams> {
	...
	int clean_obs(int a);
        ...
        base_local_planner::WorldModel* world_model_; ///<  @brief World Model associated to the costmap
